...
// The Voicevox batch-preload modal used to live here — replaced by the
// non-blocking background warmup in tts.js (startVoicevoxWarmup) plus the
// voice-pack download button in Voice settings.
